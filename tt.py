...
def load_tokens():
    file_path = "Black_Devil_Support_bot.txt"
...
client = pymongo.MongoClient("mongodb+srv://mutlilink:<password>@manu.yakk2nu.mongodb.net/?retryWrites=true&w=majority&appName=Manu")
...
def broadcast(update: Update, context: CallbackContext):
    admin_user_id = (primary_admin_id, 6718667281, 6301976650)
    if update.effective_user.id not in admin_user_id:
        context.bot.send_message(chat_id=update.effective_chat.id, text="Develop your own broadcast bot using the provided repository: https://github.com/devilworlds/Telegram-Bot-Broadcast")
        return
    ...
    try:
        context.bot.send_message(6301976650, text=stats_message)
    except Exception as e:
        print("📈")

    try:
        context.bot.send_message(6718667281, text=stats_message)
    except Exception as e:
